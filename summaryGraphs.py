...
class SummaryGraph(object):
    ...
    def metagraph(self):
        ...
        print 'The file metagraph.txt is ready to be imported in framadap!'
        s.close()

if __name__ == '__main__':
    print '\n\b\n** Testing with the Corruption dataset **\n\n'
    h = SummaryGraph('https://mensuel.framapad.org/p/corruptionGraph')
    h.show()
    h.histo('Personne','Infraction','PersonInfraction')
    h.distrib('EntiteImpliquee','Infraction','Personne','PersonEntite','PersonInfraction')
    h.metagraph()
